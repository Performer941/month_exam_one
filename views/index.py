...
def detail(news_id):
    ...
    if user:
        ...
        return render_template("index/detail.html", news=news, nick_name=nick_name, news_author=news_author, user=user,
        ...
        return render_template("index/detail.html", news=news, nick_name=nick_name, news_author=news_author,
                               click_detail_news_sex=click_detail_news_sex, comments=comments, user=user)
